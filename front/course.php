...
<div
  ...
  <div class="school-sidebar">
    <div class="sidebar-header">
      ...
      <a href="/lobby" class="back-to-lobby" title="<?php _e('חזרה לאיזור תלמידים', 'future-lms'); ?>">
        <img src="<?php echo $images_dir_url; ?>/logout.svg" alt="<?php _e('חזרה לאיזור תלמידים', 'future-lms'); ?>" />
      </a>
